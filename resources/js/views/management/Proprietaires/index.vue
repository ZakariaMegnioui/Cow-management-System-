      ...
      <el-row :gutter="40" class="panel-group">
        ...
        <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
          <div class="card-panel" >
            ...
            <div class="card-panel-description">
              <div class="card-panel-text">Archive</div>
              <count-to
                :start-val="0"
          ...
          <el-form :inline="true" :model="search" class="demo-form-inline float-end -mr-3">
            ...
            <el-form-item>
              <el-button
                ...
                type="primary"
                icon="el-icon-search"
                @click="getProprietaires(search.DateD,search.DateF)"
            ...
            <el-col :span="12">
              <el-dropdown trigger="click">
                ...
                <el-dropdown-menu slot="dropdown">
                  ...
                  <el-dropdown-item v-if="props.row.Etat === 'Active'" icon="el-icon-takeaway-box">
                  ...
                  >
                    <el-button class="Action_btn" @click="ActivateProprietaire(props.row)">Active</el-button>
                  </el-dropdown-item>
                </el-dropdown-menu>
              </el-dropdown>
            </el-col>
...
export default {
  ...
  methods: {
    ...
    createData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          Axios.post('http://127.0.0.1:8000/api/Eleveurproprietaire/', tempData)
            .then((res) => {
              this.getProprietaires('', '');
              this.temp = {};
    ...
    updateData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          console.log(tempData);
          Axios.put(
            'http://127.0.0.1:8000/api/Eleveurproprietaire/' + tempData.id,
            tempData
          )
            .then((res) => {
              this.getProprietaires('', '');
    ...
    handleDelete(row) {
      Axios.delete('http://127.0.0.1:8000/api/Eleveurproprietaire/' + row.id)
        .then((res) => {
          this.getProprietaires('', '');
          this.dialogFormVisible = false;
          console.log(res);
    ...
    getProprietaires(DateD, DateF) {
      // eslint-disable-next-line eqeqeq
      if (DateD == '' && DateF == '') {
        Axios.get('http://127.0.0.1:8000/api/Eleveurproprietaire')
          .then((res) => {
        ...
        console.log(DateF);
        Axios.get(
          `http://127.0.0.1:8000/api/Eleveurproprietaire?dateD=${DateD}&dateF=${DateF}`
        )
          .then((res) => {
    ...
    ActivateProprietaire(row) {
      Axios.put('http://127.0.0.1:8000/api/ActivatePropr/' + row.id)
        .then((res) => {
          this.getProprietaires('', '');
          this.dialogFormVisible = false;
          console.log(res);
