...
<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="Nom" prop="Nom" sortable="custom" align="center" width="80">
        <template slot-scope="scope">
          <span>{{ scope.row.id }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="Prenom" min-width="80px">
        <template slot-scope="scope">
...
export default {
  ...
  mounted() {
    // eslint-disable-next-line no-undef
    this.getSujets();
    this.getEleveursnaisseurs();
  },
  methods: {
    async getList() {
      this.listLoading = true;
      // const { data } = await fetchList(this.listQuery);
      this.list = this.Eleveursnaisseurs;
    ...
    getEleveursnaisseurs(){
      Axios.get('http://127.0.0.1:8000/api/Eleveursnaisseurs')
        .then(res => {
          // this.sujets = res.data.data;
          this.Eleveursnaisseurs = res.data.data;
